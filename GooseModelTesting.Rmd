...
# Calculate the fit:
full_join(sim_data, field_data,
          by = c("month", "habitat_use", "species")) %>%
  replace_na(list(prop_field = 0.0, prop = 0.0)) %>% 
