...
resultfilename = 'GooseParameterFitting_2017-02-15.txt'
...
* Have added range max to following likelyhood to see what if this will cause a drop in fit.
* Have also increased the max appetite scaler a bit.
...
allres = fread(file.path("~/temp/", resultfilename)) 	
invisible({
